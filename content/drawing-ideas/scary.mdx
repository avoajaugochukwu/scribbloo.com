...
You just unlocked a whole page of spooky ideas. Pick a few, color them in, and watch them come alive. For more, browse our big list of [things to draw](/drawing-ideas/things-to-draw), get extra eerie with [creepy drawing ideas](/drawing-ideas/creepy), or fill a page with [Halloween drawing ideas](/drawing-ideas/halloween). Want a step by step? Learn [how to draw a spider](/how-to-draw/spider) for your web scenes. And when you are ready to color, our [fantasy coloring pages](/coloring-pages/fantasy) are waiting. You've got this.
