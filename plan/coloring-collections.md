# Coloring Collections & Category Landings

_Theme/character collection pages + top category landings — use the **category MDX** schema._

> **How to write these:** Template: **coloring category** in `00-writing-guide.md`. Intro paragraph (50–120 words) with the primary keyword in sentence 1, a `howToGuide` (download & print steps), 3–5 benefit bullets, and an FAQ (2–4 Q&A). These pages list the printable images for that theme.
...
- **Primary:** `halloween coloring pages` — vol **74,000**/mo · KD **0** · informational
...
- **Primary:** `pokemon coloring pages` — vol **60,500**/mo · KD **0** · informational
- **Also target:** `coloring book pages pokemon` (60,500), `pokemon coloring book printable` (5,400), `pokemon coloring book` (2,400)

## 🆕 Sonic Coloring Pages
`slug: sonic-coloring-pages` · **Collection (category)**

- **Primary:** `sonic coloring pages` — vol **60,500**/mo · KD **0** · informational
- **Also target:** `coloring pages sonic the hedgehog` (60,500), `printable sonic coloring sheet` (2,400), `coloring book of sonic` (1,600)

## 🆕 Bluey Coloring Pages
`slug: bluey-coloring-pages` · **Collection (category)**

- **Primary:** `bluey coloring pages` — vol **60,500**/mo · KD **0** · informational
- **Also target:** `bluey coloring book` (1,900), `coloring pages bluey printable` (1,900), `free printable free bluey coloring pages` (50)

## 🆕 Adorable Coloring Pages
`slug: adorable-coloring-pages` · **Collection (category)**
...
- **Primary:** `labubu coloring pages` — vol **40,500**/mo · KD **0** · informational
- **Also target:** `coloring pages printable labubu` (1,900), `labubu coloring printable` (480), `coloring pages labubu drawing` (320), `cute labubu coloring pages printable` (10)
...
- **Primary:** `easter coloring pages` — vol **33,100**/mo · KD **0** · informational
- **Also target:** `coloring pages easter` (33,100), `coloring book easter` (33,100), `easter day coloring pages` (33,100), `coloring pages about easter` (33,100), `coloring book easter egg` (9,900), `easter egg coloring book page` (9,900), `easter egg coloring` (8,100), `coloring book easter bunny` (6,600), `easter bunny coloring book pages` (6,600), `free easter coloring book pages` (5,400), `free easter coloring book` (5,400)

## ✅ Dragon Coloring Pages
`slug: dragon-coloring-pages` · **Collection (category)** · _exists as `friendly-dragon` → refresh/expand_

- **Primary:** `dragon coloring pages` — vol **33,100**/mo · KD **0** · informational
- **Also target:** `coloring pages dragon` (33,100), `coloring book dragon ball z` (6,600), `dragon ball z coloring book pages` (6,600), `how to train your dragon coloring book pages` (5,400), `printable dragon coloring book` (3,600), `dragon coloring pages printable` (3,600), `free printable coloring pages dragons` (1,900), `coloring pages how to train your dragon` (260), `easy dragon coloring pages printable` (20), `coloring book how to train your dragon` (10)

## 🆕 Minecraft Coloring Pages
`slug: minecraft-coloring-pages` · **Collection (category)**
...
- **Primary:** `mario coloring pages` — vol **33,100**/mo · KD **0** · informational
- **Also target:** `coloring pages mario` (33,100), `mario coloring pages mario` (33,100), `coloring book pages mario` (33,100), `coloring pages mario characters` (33,100), `super mario character coloring pages` (33,100), `nintendo mario coloring pages` (33,100), `mario and luigi coloring book` (2,400), `mario coloring pages printable` (1,900)

## 🆕 Thanksgiving Coloring Pages
`slug: thanksgiving-coloring-pages` · **Collection (category)**

- **Primary:** `thanksgiving coloring pages` — vol **33,100**/mo · KD **0** · informational
- **Also target:** `coloring book pages thanksgiving` (33,100), `coloring book thanksgiving` (33,100), `thanksgiving day coloring pages` (33,100), `coloring pages about thanksgiving` (33,100), `thanksgiving holiday coloring pages` (33,100), `printable coloring pages for thanksgiving` (14,800), `thanksgiving coloring sheets` (14,800), `free thanksgiving coloring book pages` (8,100), `free thanksgiving coloring book` (8,100), `thanksgiving coloring book printable` (4,400), `happy thanksgiving coloring book` (1,300)

## 🆕 Paw Patrol Coloring Pages
`slug: paw-patrol-coloring-pages` · **Collection (category)**

- **Primary:** `paw patrol coloring pages` — vol **33,100**/mo · KD **0** · informational
- **Also target:** `paw patrol coloring book pages` (33,100), `coloring book paw patrol` (33,100), `paw patrol coloring book printable` (1,900)

## 🆕 Valentine Coloring Pages
`slug: valentine-coloring-pages` · **Collection (category)**

- **Primary:** `valentine coloring pages` — vol **33,100**/mo · KD **0** · informational
- **Also target:** `valentine coloring pages` (27,100), `valentine coloring book pages` (27,100), `coloring pages valentines day printable` (2,900), `easy valentines coloring pages` (1,600), `free printable coloring pages valentines day` (1,300), `printable valentine coloring pages` (1,300), `coloring book valentines` (30), `free printable coloring pages valentines day pdf` (10), `free printable coloring pages valentine heart` (10)

## 🆕 Disney Coloring Pages
`slug: disney-coloring-pages` · **Collection (category)**
...
- **Primary:** `elsa coloring pages` — vol **22,200**/mo · KD **0** · informational
- **Also target:** `coloring pages frozen elsa` (22,200), `queen elsa coloring pages` (22,200), `coloring book elsa frozen` (22,200), `coloring pages of elsa from frozen` (22,200), `elsa printable coloring pages` (1,900), `elsa free printable coloring pages` (1,600), `elsa coloring` (1,600)

## 🆕 Horse Coloring Pages
`slug: horse-coloring-pages` · **Collection (category)**
...
- **Primary:** `barbie coloring pages` — vol **18,100**/mo · KD **0** · informational
- **Also target:** `coloring pages barbie` (18,100), `coloring book pages barbie` (18,100), `barbie coloring pages print` (18,100), `coloring book barbie` (18,100), `coloring pages barbie doll` (18,100), `barbie coloring book printable` (3,600), `barbie printable coloring pages` (3,600), `barbie coloring printable` (3,600), `printable barbie coloring sheets` (3,600), `barbie color pages printable` (3,600), `easy barbie coloring pages printable` (110)

## 🆕 Heart Coloring Pages
`slug: heart-coloring-pages` · **Collection (category)**

- **Primary:** `heart coloring pages` — vol **18,100**/mo · KD **0** · informational
- **Also target:** `coloring book pages hearts` (18,100), `coloring pages heart shape` (18,100), `coloring book heart shape` (18,100), `free printable coloring pages hearts` (720), `coloring book heart` (70)

## 🆕 Mermaid Coloring Pages
`slug: mermaid-coloring-pages` · **Collection (category)**

- **Primary:** `mermaid coloring pages` — vol **18,100**/mo · KD **0** · informational
- **Also target:** `mermaid coloring book pages` (18,100), `mermaid coloring` (2,900), `mermaid coloring sheet` (2,900), `mermaid printable coloring pages` (2,400), `printable coloring pages little mermaid` (1,000), `mermaid coloring pages for adults` (390)

## ✅ Puppy Coloring Pages
`slug: puppy-coloring-pages` · **Collection (category)** · _exists as `cute-puppy` → refresh/expand_
...
- **Primary:** `rainbow coloring pages` — vol **18,100**/mo · KD **0** · informational
- **Also target:** `coloring book pages rainbow` (18,100), `rainbow coloring pages printable` (2,400), `printable coloring pages rainbow friends` (10)

## 🆕 Mickey Coloring Pages
`slug: mickey-coloring-pages` · **Collection (category)**

- **Primary:** `mickey coloring pages` — vol **18,100**/mo · KD **0** · informational
- **Also target:** `coloring pages mickey mouse` (18,100), `mickey mouse characters coloring pages` (18,100)
...
- **Primary:** `squishmallow coloring pages` — vol **14,800**/mo · KD **0** · informational
- **Also target:** `squishmallow printable coloring pages` (720)

## 🆕 Peppa Coloring Pages
`slug: peppa-coloring-pages` · **Collection (category)**

- **Primary:** `peppa coloring pages` — vol **14,800**/mo · KD **0** · informational
- **Also target:** `peppa pig coloring pages printable` (0)

## 🆕 Butterfly Coloring Pages
`slug: butterfly-coloring-pages` · **Collection (category)**

- **Primary:** `butterfly coloring pages` — vol **14,800**/mo · KD **0** · informational
- **Also target:** `coloring book pages of butterflies` (14,800), `coloring book pages butterfly` (14,800), `coloring pages butterflies` (14,800), `butterfly coloring` (8,100), `butterfly coloring book printable` (2,900), `butterfly coloring pages printable` (2,900), `free printable coloring pages of butterflies` (2,900), `butterfly coloring pages for adults` (880)

## 🆕 Pumpkin Coloring Pages
`slug: pumpkin-coloring-pages` · **Collection (category)**
...
- **Primary:** `sprunki coloring pages` — vol **14,800**/mo · KD **0** · informational
- **Also target:** `sprunki printable coloring pages` (480)

## 🆕 Star Coloring Pages
`slug: star-coloring-pages` · **Collection (category)**

- **Primary:** `star coloring pages` — vol **14,800**/mo · KD **0** · informational
- **Also target:** `coloring book pages star wars` (14,800), `star wars printing coloring pages` (14,800), `coloring book pages of stars` (2,400), `lego star wars coloring book` (1,600), `star coloring pages printable` (260)

## 🆕 Birthday Coloring Pages
`slug: birthday-coloring-pages` · **Collection (category)**
...
- **Primary:** `st patrick coloring pages` — vol **14,800**/mo · KD **0** · informational
- **Also target:** `coloring sheets for st patrick's day` (14,800), `st patrick coloring pages printable` (70), `st patricks day coloring pages for kids` (0)

## 🆕 Food Coloring Pages
`slug: food-coloring-pages` · **Collection (category)**

- **Primary:** `food coloring pages` — vol **12,100**/mo · KD **0** · informational
- **Also target:** `coloring book pages of food` (12,100), `food coloring pages printable` (1,300), `food coloring pages printable pdf` (110)

## 🆕 Football Coloring Pages
`slug: football-coloring-pages` · **Collection (category)**

- **Primary:** `football coloring pages` — vol **12,100**/mo · KD **0** · informational
- **Also target:** `football coloring book pages` (12,100), `coloring book football player` (1,900)

## 🆕 Snoopy Coloring Pages
`slug: snoopy-coloring-pages` · **Collection (category)**

- **Primary:** `snoopy coloring pages` — vol **12,100**/mo · KD **0** · informational
- **Also target:** `snoopy coloring pages printable` (320)
...
- **Primary:** `minion coloring pages` — vol **12,100**/mo · KD **0** · informational
- **Also target:** `coloring book minion` (12,100)

## 🆕 Fun Coloring Pages
`slug: fun-coloring-pages` · **Collection (category)**

- **Primary:** `fun coloring pages` — vol **12,100**/mo · KD **4** · informational
- **Also target:** `fun coloring pages for adults` (1,300), `fun coloring pages printable` (320), `cute fun coloring pages` (320), `coloring book fun` (110)

## 🆕 Pikachu Coloring Pages
`slug: pikachu-coloring-pages` · **Collection (category)**

- **Primary:** `pikachu coloring pages` — vol **12,100**/mo · KD **0** · transactional
- **Also target:** `pikachu coloring pages printable` (480)

## 🆕 Frozen Coloring Pages
`slug: frozen-coloring-pages` · **Collection (category)**
...
- **Primary:** `harry potter coloring pages` — vol **12,100**/mo · KD **0** · informational
- **Also target:** `coloring book pages harry potter` (12,100), `coloring book harry potter` (1,300), `free printable coloring pages harry potter` (20)

## 🆕 Mother Day Coloring Pages
`slug: mother-day-coloring-pages` · **Collection (category)**

- **Primary:** `mother day coloring pages` — vol **12,100**/mo · KD **0** · navigational
- **Also target:** `mother's day coloring pages printable` (390)

## 🆕 Ice Cream Coloring Pages
`slug: ice-cream-coloring-pages` · **Collection (category)**

- **Primary:** `ice cream coloring pages` — vol **12,100**/mo · KD **0** · informational
- **Also target:** `coloring pages ice cream` (12,100), `free printable coloring pages ice cream` (30)
...
- **Primary:** `turtle coloring pages` — vol **9,900**/mo · KD **0** · informational
- **Also target:** `coloring pages turtle` (9,900), `coloring book ninja turtles` (9,900), `ninja turtles coloring book pages` (9,900), `coloring pages ninja turtles` (9,900), `turtle coloring book pages` (3,600), `turtle printable coloring pages` (1,000), `sea turtle coloring pages printable` (480), `free printable coloring pages ninja turtles` (320), `free printable coloring pages turtle` (260)

## 🆕 Godzilla Coloring Pages
`slug: godzilla-coloring-pages` · **Collection (category)**
...
- **Primary:** `shark coloring pages` — vol **9,900**/mo · KD **0** · informational
- **Also target:** `shark coloring pages printable` (1,300)

## 🆕 Rabbit Coloring Pages
`slug: rabbit-coloring-pages` · **Collection (category)**
...
- **Primary:** `transformer coloring pages` — vol **9,900**/mo · KD **0** · informational
- **Also target:** `printable coloring pages transformers` (590)

## 🆕 Taylor Swift Coloring Pages
`slug: taylor-swift-coloring-pages` · **Collection (category)**

- **Primary:** `taylor swift coloring pages` — vol **9,900**/mo · KD **0** · informational
- **Also target:** `free printable coloring pages taylor swift` (170)

## 🆕 Toy Story Coloring Pages
`slug: toy-story-coloring-pages` · **Collection (category)**

- **Primary:** `toy story coloring pages` — vol **9,900**/mo · KD **0** · informational
- **Also target:** `coloring book toy story` (9,900), `coloring pages toy story` (9,900), `free printable coloring pages toy story` (260)

## 🆕 Strawberry Coloring Pages
`slug: strawberry-coloring-pages` · **Collection (category)**

- **Primary:** `strawberry coloring pages` — vol **9,900**/mo · KD **0** · informational
- **Also target:** `strawberry shortcake coloring book pages` (9,900), `strawberry coloring pages printable` (320)

## 🆕 Bird Coloring Pages
`slug: bird-coloring-pages` · **Collection (category)**

- **Primary:** `bird coloring pages` — vol **8,100**/mo · KD **0** · informational

## 🆕 Penguin Coloring Pages
`slug: penguin-coloring-pages` · **Collection (category)**
...
- **Primary:** `coloring pages` — vol **673,000**/mo · KD **0** · informational
- **Also target:** `coloring book pages to color` (673,000), `coloring pages book` (673,000), `coloring pages pages` (673,000), `coloring pages sheets` (135,000), `coloring book sheet` (135,000), `coloring sheets` (135,000), `printable coloring pages` (90,500), `coloring pages free` (90,500), `free printable coloring pages` (90,500), `coloring pages free print` (90,500), `coloring book pages free` (90,500)
